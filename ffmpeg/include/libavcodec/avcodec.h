...
const char *avcodec_get_pix_fmt_name(enum AVPixelFormat pix_fmt);
#endif
 ...
 */
attribute_deprecated enum AVPixelFormat avcodec_get_pix_fmt(const char* name);
#endif
 ...
 */
attribute_deprecated
void avcodec_pix_fmt_string (char *buf, int buf_size, enum AVPixelFormat pix_fmt);
#endif
